package com.buxuan.baseoneui.sesl.snackbar;
...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    @NonNull
    private final com.buxuan.baseoneui.sesl.snackbar.ContentViewCallback contentViewCallback;
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup viewGroup, @NonNull View view2, @NonNull com.buxuan.baseoneui.sesl.snackbar.ContentViewCallback contentViewCallback2) {
        if (viewGroup == null) {
