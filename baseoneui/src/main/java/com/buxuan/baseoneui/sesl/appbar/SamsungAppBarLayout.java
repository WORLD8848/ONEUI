package com.buxuan.baseoneui.sesl.appbar;
...
import com.buxuan.baseoneui.layout.CoordinatorLayout;
...
public class SamsungAppBarLayout extends LinearLayout implements ABLBehavior {
    ...
    public List<BaseOnOffsetChangedListener> mListeners;
    ...
    public void dispatchOffsetUpdates(int var1) {
        ...
        if (var2 != null) {
            ...
            for (int var4 = var2.size(); var3 < var4; ++var3) {
                BaseOnOffsetChangedListener var5 = (BaseOnOffsetChangedListener) this.mListeners.get(var3);
                if (var5 != null) {
    ...
    public LayoutParams generateLayoutParams(ViewGroup.LayoutParams var1) {
        if (Build.VERSION.SDK_INT >= 19 && var1 instanceof LinearLayout.LayoutParams) {
    ...
    public final boolean hasCollapsibleChild() {
        ...
        for (int var2 = 0; var2 < var1; ++var2) {
            if (((LayoutParams) this.getChildAt(var2).getLayoutParams()).isCollapsible()) {
                return true;
            }
        }
    ...
    protected static class BaseBehavior<T extends SamsungAppBarLayout> extends HeaderBehavior<T> {
        ...
        public boolean canDragView(T var1) {
            BaseDragCallback var2 = this.onDragCallback;
            if (var2 != null) {
        ...
        public final int getChildIndexOnOffset(T var1, int var2) {
            ...
            for (int var4 = 0; var4 < var3; ++var4) {
                ...
                LayoutParams var10 = (LayoutParams) var5.getLayoutParams();
                int var8 = var6;
                int var9 = var7;
        ...
        public final boolean isScrollHoldMode(T var1) {
            if (this.mToolisMouse) {
                ...
                if (var3 >= 0) {
                    var4 = var2;
                    if ((((LayoutParams) var1.getChildAt(var3).getLayoutParams()).getScrollFlags() & 65536) == 65536) {
                        var4 = false;
                    }
                }
        ...
        public void onRestoreInstanceState(CoordinatorLayout var1, T var2, Parcelable var3) {
            if (var3 instanceof BaseBehavior.SavedState) {
        ...
        public Parcelable onSaveInstanceState(CoordinatorLayout var1, T var2) {
            ...
            for (int var7 = 0; var7 < var5; ++var7) {
                ...
                if (var9.getTop() + var4 <= 0 && var8 >= 0) {
                    SavedState var10 = new SavedState(var3);
        ...
        public final void updateAppBarLayoutDrawableState(CoordinatorLayout var1, T var2, int var3, int var4, boolean var5) {
            ...
            if (var6 != null) {
                int var7 = ((LayoutParams) var6.getLayoutParams()).getScrollFlags();
                boolean var8 = false;
                boolean var9 = var8;
                if ((var7 & 1) != 0) {
                    label51:
