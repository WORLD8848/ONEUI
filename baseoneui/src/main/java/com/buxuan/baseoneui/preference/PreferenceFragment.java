...
public abstract class PreferenceFragment extends Fragment implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, DialogPreference.TargetFragment {
    ...
    public void onCreate(Bundle var1) {
        ...
        if (this.getArguments() != null) {
            var5 = this.getArguments().getString("com.buxuan.baseoneui.preference.PreferenceFragment.PREFERENCE_ROOT");
        } else {
            var5 = null;
        }
    ...
    public void onDisplayPreferenceDialog(Preference var1) {
        ...
        if (this.getCallbackFragment() instanceof OnPreferenceDisplayDialogCallback) {
            var2 = ((OnPreferenceDisplayDialogCallback) this.getCallbackFragment()).onPreferenceDisplayDialog(this, var1);
        } else {
            var2 = false;
        }
        ...
        if (!var2) {
            ...
            if (this.getActivity() instanceof OnPreferenceDisplayDialogCallback) {
                var3 = ((OnPreferenceDisplayDialogCallback) this.getActivity()).onPreferenceDisplayDialog(this, var1);
            }
        }

        if (!var3) {
            if (this.getFragmentManager().findFragmentByTag("com.buxuan.baseoneui.preference.PreferenceFragment.DIALOG") == null) {
                Object var4;
                ...
                ((DialogFragment) var4).show(this.getFragmentManager(), "com.buxuan.baseoneui.preference.PreferenceFragment.DIALOG");
            }
        }
    }
    ...
    public void onNavigateToScreen(PreferenceScreen var1) {
        ...
        if (this.getCallbackFragment() instanceof OnPreferenceStartScreenCallback) {
            var2 = ((OnPreferenceStartScreenCallback) this.getCallbackFragment()).onPreferenceStartScreen(this, var1);
        } else {
            var2 = false;
        }

        if (!var2 && this.getActivity() instanceof OnPreferenceStartScreenCallback) {
            ((OnPreferenceStartScreenCallback) this.getActivity()).onPreferenceStartScreen(this, var1);
        }
    ...
    public boolean onPreferenceTreeClick(Preference var1) {
        if (var1.getFragment() != null) {
            ...
            if (this.getCallbackFragment() instanceof OnPreferenceStartFragmentCallback) {
                var2 = ((OnPreferenceStartFragmentCallback) this.getCallbackFragment()).onPreferenceStartFragment(this, var1);
            } else {
                var2 = false;
            }
            ...
            if (!var2) {
                ...
                if (this.getActivity() instanceof OnPreferenceStartFragmentCallback) {
                    var3 = ((OnPreferenceStartFragmentCallback) this.getActivity()).onPreferenceStartFragment(this, var1);
                }
            }
