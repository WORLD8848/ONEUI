...
import com.buxuan.baseoneui.preference.internal.SeslPreferenceImageView;
...
public class Preference implements Comparable<Preference> {
    ...
    public Preference(Context var1, AttributeSet var2, int var3, int var4) {
        ...
        this.mClickListener = new OnClickListener() {
            public void onClick(View var1) {
                Preference.this.performClick(var1);
            }
        };
        this.mContext = var1;
    ...
    private void registerDependency() {
        if (!TextUtils.isEmpty(this.mDependencyKey)) {
            Preference var1 = this.findPreferenceInHierarchy(this.mDependencyKey);
            if (var1 == null) {
    ...
    private void registerDependent(Preference var1) {
    ...
    private void unregisterDependent(Preference var1) {
        if (this.mDependents != null) {
    ...
    protected Preference findPreferenceInHierarchy(String var1) {
        Preference var2;
    ...
    public void notifyDependencyChange(boolean var1) {
        ...
        if (var2 != null) {
            ...
            for (int var4 = 0; var4 < var3; ++var4) {
                ((Preference) var2.get(var4)).onDependencyChanged(this, var1);
            }
        }
    ...
    public void onDependencyChanged(Preference var1, boolean var2) {
    ...
    public void onParentChanged(Preference var1, boolean var2) {
    ...
    protected void onRestoreInstanceState(Parcelable var1) {
        ...
        if (var1 != BaseSavedState.EMPTY_STATE && var1 != null) {
    ...
    final void setOnPreferenceChangeInternalListener(OnPreferenceChangeInternalListener var1) {
        this.mListener = var1;
    }
    ...
    public void setOnPreferenceClickListener(OnPreferenceClickListener var1) {
    ...
    interface OnPreferenceChangeInternalListener {
        void onPreferenceChange(Preference var1);

        void onPreferenceHierarchyChange(Preference var1);
    }

    public interface OnPreferenceChangeListener {
        boolean onPreferenceChange(Preference var1, Object var2);
    }

    public interface OnPreferenceClickListener {
        boolean onPreferenceClick(Preference var1);
    }

    public static class BaseSavedState extends AbsSavedState {
        public static final Creator<BaseSavedState> CREATOR = new Creator<BaseSavedState>() {
            public BaseSavedState createFromParcel(Parcel var1) {
                return new BaseSavedState(var1);
            }

            public BaseSavedState[] newArray(int var1) {
                return new BaseSavedState[var1];
            }
        };
