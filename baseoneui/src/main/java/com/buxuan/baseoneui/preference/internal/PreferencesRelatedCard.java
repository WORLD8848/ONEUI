...
public class PreferencesRelatedCard extends LinearLayout {
    ...
    private void init() {
        ...
        mParentView.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
    ...
    public PreferencesRelatedCard addButton(CharSequence titleText, OnClickListener ocl) {
        ...
        mCardContainer.addView(textView, new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        return this;
    }
