...
import com.buxuan.baseoneui.sesl.appbar.SamsungAppBarLayout;
import com.buxuan.baseoneui.sesl.appbar.SamsungCollapsingToolbarLayout;
import com.buxuan.baseoneui.sesl.support.ViewSupport;
import com.buxuan.baseoneui.sesl.support.WindowManagerSupport;
import com.buxuan.baseoneui.sesl.widget.ActionModeBottomBarButton;
    ...
    private void showOverflowMenuButtonBadge(int count) {
        ...
        if (moreOverflowBadgeText != null) {
            if (count > 0) {
                ...
                int width = (int) (getResources().getDimension(R.dimen.sesl_badge_default_width) + (float) countString.length() * getResources().getDimension(R.dimen.sesl_badge_additional_width));
                MarginLayoutParams lp = (MarginLayoutParams) moreOverflowBadgeBackground.getLayoutParams();
                lp.width = width;
                lp.height = (int) getResources().getDimension(R.dimen.sesl_menu_item_badge_size);
