...
import com.buxuan.baseoneui.sesl.recyclerview.DefaultItemAnimator;
import com.buxuan.baseoneui.sesl.recyclerview.FastScroller;
import com.buxuan.baseoneui.sesl.recyclerview.SeslAdapterHelper;
import com.buxuan.baseoneui.sesl.recyclerview.SeslChildHelper;
import com.buxuan.baseoneui.sesl.recyclerview.SeslGapWorker;
import com.buxuan.baseoneui.sesl.recyclerview.SeslLinearLayoutManager;
import com.buxuan.baseoneui.sesl.recyclerview.SeslOverScroller;
import com.buxuan.baseoneui.sesl.recyclerview.SeslRecyclerViewAccessibilityDelegate;
import com.buxuan.baseoneui.sesl.recyclerview.SeslRecyclerViewFastScroller;
import com.buxuan.baseoneui.sesl.recyclerview.SeslViewBoundsCheck;
import com.buxuan.baseoneui.sesl.recyclerview.SeslViewInfoStore;
import com.buxuan.baseoneui.sesl.recyclerview.StaggeredGridLayoutManager;
...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2, ScrollingView {
    ...
    public static ViewHolder getChildViewHolderInt(View var0) {
        ViewHolder var1;
        if (var0 == null) {
            var1 = null;
        } else {
            var1 = ((LayoutParams) var0.getLayoutParams()).mViewHolder;
        }
    ...
    static void getDecoratedBoundsWithMarginsInt(View var0, Rect var1) {
        LayoutParams var2 = (LayoutParams) var0.getLayoutParams();
    ...
    private void dispatchLayoutStep1() {
        ...
        if (this.mState.mRunSimpleAnimations) {
            ...
            for (var4 = 0; var4 < var3; ++var4) {
                ViewHolder var5 = getChildViewHolderInt(this.mChildHelper.getChildAt(var4));
                if (!var5.shouldIgnore() && (!var5.isInvalid() || this.mAdapter.hasStableIds())) {
                    ItemAnimator.ItemHolderInfo var9 = this.mItemAnimator.recordPreLayoutInformation(this.mState, var5, ItemAnimator.buildAdapterChangeFlagsForAnimations(var5), var5.getUnmodifiedPayloads());
        ...
        if (this.mState.mRunPredictiveAnimations) {
            ...
            for (var4 = 0; var4 < this.mChildHelper.getChildCount(); ++var4) {
                ViewHolder var10 = getChildViewHolderInt(this.mChildHelper.getChildAt(var4));
                if (!var10.shouldIgnore() && !this.mViewInfoStore.isInPreLayout(var10)) {
                    int var8 = ItemAnimator.buildAdapterChangeFlagsForAnimations(var10);
                    ...
                    ItemAnimator.ItemHolderInfo var11 = this.mItemAnimator.recordPreLayoutInformation(this.mState, var10, var3, var10.getUnmodifiedPayloads());
                    if (var2) {
    ...
    private void dispatchLayoutStep3() {
        ...
        if (this.mState.mRunSimpleAnimations) {
            for (var1 = this.mChildHelper.getChildCount() - 1; var1 >= 0; --var1) {
                ViewHolder var2 = getChildViewHolderInt(this.mChildHelper.getChildAt(var1));
                if (!var2.shouldIgnore()) {
                    long var3 = this.getChangedHolderKey(var2);
                    ItemAnimator.ItemHolderInfo var5 = this.mItemAnimator.recordPostLayoutInformation(this.mState, var2);
                    ViewHolder var6 = this.mViewInfoStore.getFromOldChangeHolders(var3);
                    if (var6 != null && !var6.shouldIgnore()) {
                        ...
                        if (var7 && var6 == var2) {
                            ...
                            ItemAnimator.ItemHolderInfo var9 = this.mViewInfoStore.popFromPreLayout(var6);
                            this.mViewInfoStore.addToPostLayout(var2, var5);
    ...
    private boolean dispatchOnItemTouch(MotionEvent var1) {
        ...
        if (var3 != 0) {
            ...
            for (var3 = 0; var3 < var4; ++var3) {
                OnItemTouchListener var5 = (OnItemTouchListener) this.mOnItemTouchListeners.get(var3);
    ...
    private boolean dispatchOnItemTouchIntercept(MotionEvent var1) {
        ...
        while (true) {
            ...
            OnItemTouchListener var5 = (OnItemTouchListener) this.mOnItemTouchListeners.get(var4);
    ...
    private void findMinMaxChildLayoutPositions(int[] var1) {
        ...
        if (var2 == 0) {
            ...
            for (int var5 = 0; var5 < var2; var4 = var7) {
                ViewHolder var6 = getChildViewHolderInt(this.mChildHelper.getChildAt(var5));
    ...
    private void handleMissingPreInfoForChangeError(long var1, ViewHolder var3, ViewHolder var4) {
        ...
        for (int var6 = 0; var6 < var5; ++var6) {
            ViewHolder var7 = getChildViewHolderInt(this.mChildHelper.getChildAt(var6));
    ...
    private boolean hasUpdatedView() {
        ...
        while (true) {
            ...
            ViewHolder var3 = getChildViewHolderInt(this.mChildHelper.getChildAt(var2));
    ...
    private void requestChildOnScreen(View var1, View var2) {
        ...
        ViewGroup.LayoutParams var7 = var4.getLayoutParams();
        Rect var5;
    ...
    void clearOldPositions() {
        ...
        for (int var2 = 0; var2 < var1; ++var2) {
            ViewHolder var3 = getChildViewHolderInt(this.mChildHelper.getUnfilteredChildAt(var2));
    ...
    void defaultOnMeasure(int var1, int var2) {
        this.setMeasuredDimension(LayoutManager.chooseSize(var1, this.getPaddingLeft() + this.getPaddingRight(), ViewCompat.getMinimumWidth(this)), LayoutManager.chooseSize(var2, this.getPaddingTop() + this.getPaddingBottom(), ViewCompat.getMinimumHeight(this)));
    }

    void dispatchChildAttached(View var1) {
        ViewHolder var2 = getChildViewHolderInt(var1);
        ...
        if (this.mOnChildAttachStateListeners != null) {
            for (int var3 = this.mOnChildAttachStateListeners.size() - 1; var3 >= 0; --var3) {
                ((OnChildAttachStateChangeListener) this.mOnChildAttachStateListeners.get(var3)).onChildViewAttachedToWindow(var1);
            }
        }
    ...
    void dispatchChildDetached(View var1) {
        ...
        if (this.mOnChildAttachStateListeners != null) {
            for (int var3 = this.mOnChildAttachStateListeners.size() - 1; var3 >= 0; --var3) {
                ((OnChildAttachStateChangeListener) this.mOnChildAttachStateListeners.get(var3)).onChildViewDetachedFromWindow(var1);
            }
        }
    ...
    protected void dispatchDraw(Canvas var1) {
        ...
        for (var3 = 0; var3 < var2; ++var3) {
            ((ItemDecoration) this.mItemDecorations.get(var3)).seslOnDispatchDraw(var1, this, this.mState);
        }
    ...
    void dispatchOnScrolled(int var1, int var2) {
        ...
        if (this.mScrollListeners != null) {
            for (var4 = this.mScrollListeners.size() - 1; var4 >= 0; --var4) {
                ((OnScrollListener) this.mScrollListeners.get(var4)).onScrolled(this, var1, var2);
            }
        }
    ...
    void dispatchPendingImportantForAccessibilityChanges() {
        for (int var1 = this.mPendingAccessibilityImportanceChange.size() - 1; var1 >= 0; --var1) {
            ViewHolder var2 = (ViewHolder) this.mPendingAccessibilityImportanceChange.get(var1);
        ...
        if (this.mItemAnimator != null && this.mItemAnimator.isRunning() && this.mItemAnimator.getItemAnimationTypeInternal() == 2) {
            ...
            switch (var3) {
                ...
                case 212:
                    if (this.isSupportGotoTop() && this.mGoToTopState == 2) {
                        if (this.canScrollUp()) {
                            SeslOnGoToTopClickListener var10 = this.mSeslOnGoToTopClickListener;
                            ...
                            if (this.computeVerticalScrollOffset() != 0) {
                                this.stopScroll();
                                LayoutManager var11 = this.mLayout;
    ...
    public void draw(Canvas var1) {
        ...
        int var4;
        for (var4 = 0; var4 < var3; ++var4) {
            ((ItemDecoration) this.mItemDecorations.get(var4)).onDrawOver(var1, this, this.mState);
        }
    ...
    public ViewHolder findViewHolderForAdapterPosition(int var1) {
        ...
        if (this.mDataSetHasChangedAfterLayout) {
            ...
            for (int var4 = 0; var4 < var3; var2 = var6) {
                ViewHolder var5 = getChildViewHolderInt(this.mChildHelper.getUnfilteredChildAt(var4));
                var6 = var2;
                if (var5 != null) {
                    var6 = var2;
                    if (!var5.isRemoved()) {
    ...
    public ViewHolder findViewHolderForItemId(long var1) {
        ...
        if (this.mAdapter != null && this.mAdapter.hasStableIds()) {
            ...
            for (int var5 = 0; var5 < var4; var3 = var7) {
                ViewHolder var6 = getChildViewHolderInt(this.mChildHelper.getUnfilteredChildAt(var5));
                var7 = var3;
                if (var6 != null) {
                    var7 = var3;
                    if (!var6.isRemoved()) {
    ...
    int getAdapterPositionFor(ViewHolder var1) {
        int var2;
    ...
    public long getChildItemId(View var1) {
        ...
        if (this.mAdapter != null) {
            if (!this.mAdapter.hasStableIds()) {
                ...
                ViewHolder var6 = getChildViewHolderInt(var1);
                var4 = var2;
                if (var6 != null) {
                    var4 = var6.getItemId();
                }
    ...
    Rect getItemDecorInsetsForChild(View var1) {
        ...
        if (!var2.mInsetsDirty) {
            ...
            for (int var5 = 0; var5 < var4; ++var5) {
                ...
                ((ItemDecoration) this.mItemDecorations.get(var5)).getItemOffsets(this.mTempRect, var1, this, this.mState);
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new SeslAdapterHelper(new SeslAdapterHelper.Callback() {
            ...
            public ViewHolder findViewHolder(int var1) {
                ViewHolder var2 = RecyclerView.this.findViewHolderForPosition(var1, true);
                ViewHolder var3;
                if (var2 == null) {
                    var3 = null;
                } else {
            ...
            public void offsetPositionsForRemovingInvisible(int var1, int var2) {
                ...
                RecyclerView.this.mItemsAddedOrRemoved = true;
                State var3 = RecyclerView.this.mState;
    ...
    void markItemDecorInsetsDirty() {
        ...
        for (int var2 = 0; var2 < var1; ++var2) {
            ((LayoutParams) this.mChildHelper.getUnfilteredChildAt(var2).getLayoutParams()).mInsetsDirty = true;
        }
    ...
    void offsetPositionRecordsForMove(int var1, int var2) {
        ...
        for (int var7 = 0; var7 < var3; ++var7) {
            ViewHolder var8 = getChildViewHolderInt(this.mChildHelper.getUnfilteredChildAt(var7));
    ...
    public void onDraw(Canvas var1) {
        ...
        for (int var3 = 0; var3 < var2; ++var3) {
            ((ItemDecoration) this.mItemDecorations.get(var3)).onDraw(var1, this, this.mState);
        }
    ...
    protected void onRestoreInstanceState(Parcelable var1) {
        if (!(var1 instanceof SavedState)) {
            ...
            this.mPendingSavedState = (SavedState) var1;
    ...
    void repositionShadowingViews() {
        ...
        for (int var2 = 0; var2 < var1; ++var2) {
            ...
            ViewHolder var4 = this.getChildViewHolder(var3);
    ...
    public void requestDisallowInterceptTouchEvent(boolean var1) {
        ...
        for (int var3 = 0; var3 < var2; ++var3) {
            ((OnItemTouchListener) this.mOnItemTouchListeners.get(var3)).onRequestDisallowInterceptTouchEvent(var1);
        }
    ...
    public void seslSetFastScrollerEventListener(SeslFastScrollerEventListener var1) {
    ...
    public void seslSetLongPressMultiSelectionListener(SeslLongPressMultiSelectionListener var1) {
        this.mLongPressMultiSelectionListener = var1;
    }

    public void seslSetOnGoToTopClickListener(SeslOnGoToTopClickListener var1) {
        this.mSeslOnGoToTopClickListener = var1;
    }

    public void seslSetOnMultiSelectedListener(SeslOnMultiSelectedListener var1) {
    ...
    public abstract static class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(VH var1, int var2) {
            ...
            var1.clearPayload();
            ViewGroup.LayoutParams var3 = var1.itemView.getLayoutParams();
            if (var3 instanceof LayoutParams) {
                ((LayoutParams) var3).mInsetsDirty = true;
            }
    ...
    public abstract static class ItemAnimator {
        ...
        public boolean canReuseUpdatedViewHolder(ViewHolder var1, List<Object> var2) {
        ...
        public final void dispatchAnimationsFinished() {
            ...
            for (int var2 = 0; var2 < var1; ++var2) {
                ((ItemAnimatorFinishedListener) this.mFinishedListeners.get(var2)).onAnimationsFinished();
            }
        ...
        public void setGroupViewHolderInternal(ViewHolder var1) {
        ...
        public ItemHolderInfo recordPreLayoutInformation(State var1, ViewHolder var2, int var3, List<Object> var4) {
            return this.obtainHolderInfo().setFrom(var2);
        }
    ...
    public abstract static class ItemDecoration {
        ...
        public void seslOnDispatchDraw(Canvas var1, RecyclerView var2, State var3) {
        }
    }
    ...
    public abstract static class LayoutManager {
        ...
        private void onSmoothScrollerStopped(SmoothScroller var1) {
        ...
        public LayoutParams generateLayoutParams(ViewGroup.LayoutParams var1) {
            ...
            if (var1 instanceof LayoutParams) {
                ...
                var2 = new LayoutParams((MarginLayoutParams) var1);
            } else {
        ...
        public boolean hasFlexibleChildInBothOrientations() {
            ...
            while (true) {
                ...
                ViewGroup.LayoutParams var3 = this.getChildAt(var2).getLayoutParams();
        ...
        public boolean shouldMeasureChild(View var1, int var2, int var3, LayoutParams var4) {
            boolean var5;
        ...
        public boolean shouldReMeasureChild(View var1, int var2, int var3, LayoutParams var4) {
            boolean var5;
    ...
    public static class RecycledViewPool {
        ...
        public ViewHolder getRecycledView(int var1) {
            ...
            if (var2 != null && !var2.mScrapHeap.isEmpty()) {
                ...
                var3 = (ViewHolder) var4.remove(var4.size() - 1);
            } else {
                var3 = null;
            }
        ...
        int size() {
            ...
            for (int var2 = 0; var2 < this.mScrap.size(); var1 = var4) {
                ArrayList var3 = ((ScrapData) this.mScrap.valueAt(var2)).mScrapHeap;
                var4 = var1;
                if (var3 != null) {
                    var4 = var1 + var3.size();
                }
    ...
    public static class State {
        ...
        public void prepareForNestedPrefetch(Adapter var1) {
            this.mLayoutStep = 1;
    ...
    public final class Recycler {
        ...
        public void addViewHolderToRecycledViewPool(ViewHolder var1, boolean var2) {
        ...
        public void bindViewToPosition(View var1, int var2) {
            ...
            if (var3 == null) {
                ...
                if (var4 >= 0 && var4 < RecyclerView.this.mAdapter.getItemCount()) {
                    ...
                    ViewGroup.LayoutParams var6 = var3.itemView.getLayoutParams();
                    LayoutParams var7;
                    if (var6 == null) {
                        var7 = (LayoutParams) RecyclerView.this.generateDefaultLayoutParams();
                        var3.itemView.setLayoutParams(var7);
                    } else if (!RecyclerView.this.checkLayoutParams(var6)) {
                        var7 = (LayoutParams) RecyclerView.this.generateLayoutParams(var6);
                        var3.itemView.setLayoutParams(var7);
                    } else {
        ...
        void clearOldPositions() {
            ...
            for (var2 = 0; var2 < var1; ++var2) {
                ((ViewHolder) this.mCachedViews.get(var2)).clearOldPosition();
            }

            var1 = this.mAttachedScrap.size();

            for (var2 = 0; var2 < var1; ++var2) {
                ((ViewHolder) this.mAttachedScrap.get(var2)).clearOldPosition();
            }
            ...
            if (this.mChangedScrap != null) {
                ...
                for (var2 = 0; var2 < var1; ++var2) {
                    ((ViewHolder) this.mChangedScrap.get(var2)).clearOldPosition();
                }
            }
            ...
            if (this.mChangedScrap != null) {
                ...
                if (var2 != 0) {
                    for (int var4 = 0; var4 < var2; ++var4) {
                        var3 = (ViewHolder) this.mChangedScrap.get(var4);
                    ...
                    if (RecyclerView.this.mAdapter.hasStableIds()) {
                        ...
                        if (var1 > 0 && var1 < RecyclerView.this.mAdapter.getItemCount()) {
                            ...
                            for (var1 = 0; var1 < var2; ++var1) {
                                var3 = (ViewHolder) this.mChangedScrap.get(var1);
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int var1, boolean var2) {
            ...
            while (true) {
                if (var4 >= var3) {
                    ...
                    for (var4 = 0; var4 < var3; ++var4) {
                        ViewHolder var7 = (ViewHolder) this.mCachedViews.get(var4);
                ...
                var5 = (ViewHolder) this.mAttachedScrap.get(var4);
        ...
        void markItemDecorInsetsDirty() {
            ...
            for (int var2 = 0; var2 < var1; ++var2) {
                LayoutParams var3 = (LayoutParams) ((ViewHolder) this.mCachedViews.get(var2)).itemView.getLayoutParams();
                if (var3 != null) {
        ...
        void markKnownViewsInvalid() {
            ...
            for (int var2 = 0; var2 < var1; ++var2) {
                ViewHolder var3 = (ViewHolder) this.mCachedViews.get(var2);
                if (var3 != null) {
                    var3.addFlags(6);
        ...
        void offsetPositionRecordsForMove(int var1, int var2) {
            ...
            for (int var7 = 0; var7 < var6; ++var7) {
                ViewHolder var8 = (ViewHolder) this.mCachedViews.get(var7);
                                ...
                                if (RecyclerView.ALLOW_THREAD_GAP_WORK) {
                                    ...
                                    if (var10 > 0) {
                                        ...
                                        if (!RecyclerView.this.mPrefetchRegistry.lastPrefetchIncludedPosition(var1.mPosition)) {
                                            ...
                                            while (var10 >= 0) {
                                                var9 = ((ViewHolder) this.mCachedViews.get(var10)).mPosition;
        ...
        public ViewHolder tryGetViewHolderForPositionByDeadline(int var1, boolean var2, long var3) {
            if (var1 >= 0 && var1 < RecyclerView.this.mState.getItemCount()) {
                boolean var5 = false;
                ...
                if (var5 && !RecyclerView.this.mState.isPreLayout() && var6.hasAnyOfTheFlags(8192)) {
                    ...
                    if (RecyclerView.this.mState.mRunSimpleAnimations) {
                        int var16 = ItemAnimator.buildAdapterChangeFlagsForAnimations(var6);
                        ItemAnimator.ItemHolderInfo var18 = RecyclerView.this.mItemAnimator.recordPreLayoutInformation(RecyclerView.this.mState, var6, var16 | 4096, var6.getUnmodifiedPayloads());
                ...
                ViewGroup.LayoutParams var19 = var6.itemView.getLayoutParams();
                LayoutParams var20;
                if (var19 == null) {
                    var20 = (LayoutParams) RecyclerView.this.generateDefaultLayoutParams();
                    var6.itemView.setLayoutParams(var20);
                } else if (!RecyclerView.this.checkLayoutParams(var19)) {
                    var20 = (LayoutParams) RecyclerView.this.generateLayoutParams(var19);
                    var6.itemView.setLayoutParams(var20);
                } else {
                    var20 = (LayoutParams) var19;
                }
        ...
        void viewRangeUpdate(int var1, int var2) {
            for (int var3 = this.mCachedViews.size() - 1; var3 >= 0; --var3) {
                ViewHolder var4 = (ViewHolder) this.mCachedViews.get(var3);
                if (var4 != null) {
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            if (RecyclerView.this.mLayout == null) {
                ...
                SmoothScroller var2 = RecyclerView.this.mLayout.mSmoothScroller;
